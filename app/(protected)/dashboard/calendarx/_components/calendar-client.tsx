...
const CalendarClient = () => {
  ...
  return (
    <div className='flex gap-6'>
      {/* Sidebar */}
      <div className='hidden w-[300px] flex-col gap-6 lg:flex'>
        {/* Quick Actions */}
        <Card>
          <CardHeader>
                ...
                {upcomingEvents.map((event) => (
                  <div key={event.Id} className='flex flex-col space-y-1'>
                    <div className='flex items-center gap-2'>
                      <div className='h-2 w-2 rounded-full' style={{ backgroundColor: event.CategoryColor }} />
                    ...
                    <Badge variant='secondary' className='ml-4 w-fit'>
                      {event.Category}
                    </Badge>
                  </div>
                ))}
        ...
        <Card>
          <CardContent className='p-6'>
            ...
            >
              <ViewsDirective>
                {views.map((item) => (
                  <ViewDirective key={item.option} option={item.option} allowVirtualScrolling={item.allowVirtualScrolling} />
                ))}
              </ViewsDirective>
