...
import { Activity } from "../../leads/_components/lead-form"
...
export default function ActivityFormDrawer({ isOpen, setIsOpen, leadId, activity, setActivity }: ActivityFormDrawerProps) {
