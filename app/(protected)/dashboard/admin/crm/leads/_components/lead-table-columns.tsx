...
type LeadsData = Awaited<ReturnType<typeof getLeads>>[number]

export function getColumns(): ColumnDef<LeadsData>[] {
  return [
    {
      accessorKey: "name",
    ...
    },
    {
      ...
      id: "last interaction",
      header: ({ column }) => <DataTableColumnHeader column={column} title='Last Interaction' />,
      cell: ({ row }) => (
          ...
          <>
            <DropdownMenu>
              ...
              <DropdownMenuContent align='end'>
                ...
                <DropdownMenuItem onClick={() => router.push(`/dashboard/admin/crm/leads/${id}`)}>
