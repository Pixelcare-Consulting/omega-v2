...
export default function LeadFormHeader({ lead }: LeadFormHeaderProps) {
  ...
  return (
    <div className='hidden md:block'>
      <div className='mb-3 rounded-lg border p-8'>
        <div className='flex flex-col gap-1'>
          <h1 className='text-2xl font-extrabold'>{lead.name}</h1>
          <div className='flex flex-wrap gap-1'>
            <p className='w-fit rounded-md bg-primary/10 p-2 text-xs font-medium text-primary'>{lead.company}</p>
            <p className='w-fit rounded-md bg-primary/10 p-2 text-xs font-medium text-primary'>{lead.title}</p>
            <p className='w-fit rounded-md bg-primary/10 p-2 text-xs font-medium text-primary'>{lead.email}</p>
            <p className='w-fit rounded-md bg-primary/10 p-2 text-xs font-medium text-primary'>{lead.phone}</p>
          </div>
        </div>
      </div>
      ...
      <div className='mx-auto w-full pb-24 pt-10'>
