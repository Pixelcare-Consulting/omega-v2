...
import SupplierOfferSummaryTab from "./tabs/supplier-offer-summary-tab"
import SupplierOfferLineItemsTab from "./tabs/supplier-offer-line-items.tab"

type ViewSupplierOfferProps = {
  supplierOffer: NonNullable<Awaited<ReturnType<typeof getSupplierOfferByCode>>>
}

export default function ViewSupplierOffer({ supplierOffer }: ViewSupplierOfferProps) {
  const supplierName = supplierOffer.supplier?.CardName

  return (
    <PageWrapper
      title='Supplier Offer Details'
      description='View the comprehensive details of this supplier offer.'
      actions={
        <div className='flex items-center gap-2'>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
              ...
              <DropdownMenuItem asChild>
                <Link href={`/dashboard/crm/supplier-offers/${supplierOffer.code}`}>
    ...
    >
      <div className='flex flex-col gap-4'>
        <Card className='flex items-center gap-3 rounded-lg p-6 shadow-md'>
          ...
          <div className='flex flex-col gap-y-2 md:gap-0'>
            ...
            <div className='flex flex-wrap items-center gap-2'>
              <p className='text-sm text-muted-foreground'>#{supplierOffer.code}</p>
            </div>
          </div>
        </Card>
        ...
        <Tabs defaultValue='1' className='w-full'>
          ...
          <TabsContent value='1'>
            <SupplierOfferSummaryTab supplierOffer={supplierOffer} />
          </TabsContent>

          <TabsContent value='2'>
            <SupplierOfferLineItemsTab supplierOffer={supplierOffer} />
          </TabsContent>
        </Tabs>
      </div>
    </PageWrapper>
