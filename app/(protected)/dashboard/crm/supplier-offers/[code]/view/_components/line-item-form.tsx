...
import { lineItemFormSchema, type LineItemForm } from "@/schema/supplier-offer"
import { zodResolver } from "@hookform/resolvers/zod"
import { LineItemsJSONData, updateLineItems } from "@/actions/supplier-offer"
...
function LineItemForm({ supplierOfferId, lineItems }: LineItemFormProps) {
  ...
  const onSubmit = useCallback(
    async (formData: LineItemForm) => {
      try {
        ...
        const response = await executeAsync({ action, supplierOfferId, lineItems: newLineItems })
    ...
    [supplierOfferId, JSON.stringify(lineItems), JSON.stringify(lineItem)]
  )
