...
type SupplierOfferListProps = {
  fileName: string
  lineItems: NonNullable<Awaited<ReturnType<typeof getSupplierOfferLineItemsByFileName>>>
}

export default function SupplierOfferLineItemList({ fileName, lineItems }: SupplierOfferListProps) {
