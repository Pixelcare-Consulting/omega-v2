...
import { getColumns } from "./supplier-offer-table-column"

type SupplierOfferListProps = {
  supplierOffers: NonNullable<Awaited<ReturnType<typeof getSupplierOffers>>>
}

export default function SupplierOfferList({ supplierOffers }: SupplierOfferListProps) {
