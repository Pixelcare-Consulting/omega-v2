...
type SupplierOfferLineItemData = NonNullable<Awaited<ReturnType<typeof getSupplierOfferLineItemsByPartialMpn>>>[number]

export function getColumns(): ColumnDef<SupplierOfferLineItemData>[] {
  return [
    {
