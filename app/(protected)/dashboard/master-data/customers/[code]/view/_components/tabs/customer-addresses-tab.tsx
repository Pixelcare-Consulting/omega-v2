  ...
  return (
    <Card className='rounded-lg p-6 shadow-md'>
      <div className='grid grid-cols-12 gap-x-3 gap-y-5'>
        <ReadOnlyFieldHeader className='col-span-12' title='Addresses' description="Customer's related addresses" actions={<Actions />} />

        <div className='col-span-12'>
          <CustomerAddressesList addresses={addresses} billToDef={billToDef} shipToDef={shipToDef} />
        </div>
      </div>
