...
import { getColumns } from "./customer-addresses-column"
...
export default function CustomerAddressesList({ addresses, billToDef, shipToDef }: CustomerAddressesListProps) {
