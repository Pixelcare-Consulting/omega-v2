...
import { getColumns } from "./customer-excess-list-table-column"

type CustomerExcessListProps = {
  custCode: string
  customerExcesses: Awaited<ReturnType<typeof getCustomerExcessesByCustomerCode>>
  isLoading: boolean
  callback: () => void
}

export default function CustomerExcessList({ custCode, customerExcesses, isLoading, callback }: CustomerExcessListProps) {
      ...
      <div className='flex flex-col items-stretch justify-center gap-2 md:flex-row md:items-center md:justify-between'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <DataImportExport
            ...
            code={`customer-${custCode}-customer-excesses`}
          />
        </div>
      </div>
    </DataTable>
