...
import { getColumns } from "./supplier-contacts-column"
...
type SupplierContactsListProps = {
  contacts: NonNullable<Awaited<ReturnType<typeof getBpMasterByCardCode>>>["contacts"]
  contactPerson?: string | null
}

export default function SupplierContactsList({ contacts, contactPerson }: SupplierContactsListProps) {
