...
export const requisitionFormSchema = z.object({
  ...
  salesPersons: z.array(z.string()).max(20, { message: "Please select at most 20 people" }).nullish(),
  salesTeam: z.array(z.string()).max(20, { message: "Please select at most 20 people" }).nullish(),
